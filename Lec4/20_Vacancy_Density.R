...
##------------------------------------------------------------------------------
datVacant <- readRDS("Lec4/data/Violations.Rds")
datBuild <- readRDS("Lec4/data/Building_Violations.Rds")


datBuild
str(datBuild)

clipper(colnames(datBuild))
datBuild <- datBuild[,c("ID",
                           "VIOLATION.DATE",
                           "VIOLATION.STATUS",
...
saveRDS(datBuild, "Lec4/data/Building_Violations.Rds")
